                  ...
                  <div class="hidden-lg row news-menu" >
                    ...
                    ======================= -->
                      ...
                      <div class="news-filter-btn col-xs-2 col-xs-offset-1">
                        <div class="news-btn"><img src="$ThemeDir/img/SoD__FirstYear_SubLogo.png" class="img-responsive"></div>
                      </div>
                      <div class="news-filter-btn col-xs-2">
                        <div class="news-btn"><img src="$ThemeDir/SoD__Media_SubLogo.png" class="img-responsive"></div>
                      </div>
                      <div class="news-filter-btn col-xs-2">
                        <div class="news-btn"><img src="$ThemeDir/img/dep_logo_Industrial_sm.png" class="img-responsive"></div>
                      </div>
                      <div class="news-filter-btn col-xs-2">
                        <div class="news-btn"><img src="$ThemeDir/img/SoD__CultureContext_SubLogo.png" class="img-responsive"></div>
                      </div>
                      <div class="news-filter-btn col-xs-2 col">
                        <div class="news-btn"><img src="$ThemeDir/img/SoD__MDI_SubLogo.png" class="img-responsive"></div>
                      </div>
                  ...
                  <div class="hidden-xs hidden-sm department-section">
                    ...
                    <div class="hidden-xs hidden-sm row news-menu">
                      ...
                      ======================= -->
                        ...
                        <div class="news-filter-btn col-xs-2">
                          <div class="news-btn"><img src="$ThemeDir/img/SoD__Media_SubLogo.png" class="img-responsive"></div>
                        </div>
                        <div class="news-filter-btn col-xs-2">
                          <div class="news-btn"><img src="$ThemeDir/img/SoD__Industrial_SubLogo.png" class="img-responsive"></div>
                        </div>
                        <div class="news-filter-btn col-xs-2">
                          <div class="news-btn"><img src="$ThemeDir/img/SoD__CultureContext_SubLogo.png" class="img-responsive"></div>
                        </div>
